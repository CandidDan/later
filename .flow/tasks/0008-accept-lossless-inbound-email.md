...
notes: ["Run after later-0007 so email enrichment can reuse the durable asset lifecycle. Resend is the selected v0 inbound provider: it signs email.received webhooks, retains the full parsed email for API retrieval, and exposes temporary attachment downloads. Official references: https://resend.com/docs/dashboard/receiving/introduction and https://resend.com/docs/webhooks/verify-webhooks-requests."]
---
